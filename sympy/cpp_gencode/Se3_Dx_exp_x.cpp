...
result[25] = -c30 + c33;
result[26] = c34 + c36;
result[27] = upsilon[0] * (c26 * c40 - c38 * omega[0]) +
             upsilon[1] * (c49 + c52) + upsilon[2] * (c43 + c48);
result[28] = upsilon[0] * (c26 * c55 - c38 * omega[1] + c53) +
             upsilon[1] * (c64 + c67) + upsilon[2] * (c56 - c57 + c59 + c62);
result[29] = upsilon[0] * (c26 * c70 - c38 * omega[2] + c68) +
             upsilon[1] * (-c71 + c72 + c74 + c75) + upsilon[2] * (c76 + c77);
result[30] = c30 + c33;
result[31] = c31 * c79 + 1;
result[32] = -c80 + c81;
result[33] = upsilon[0] * (c49 + c87) +
             upsilon[1] * (c40 * c83 - c60 * c79 + c82) +
             upsilon[2] * (c75 - c84 + c85 + c86);
result[34] = upsilon[0] * (c64 + c76) +
             upsilon[1] * (c55 * c83 - c88 * omega[1]) +
             upsilon[2] * (c89 + c91);
result[35] = upsilon[0] * (c62 + c71 - c72 + c74) +
             upsilon[1] * (c68 + c70 * c83 - c88 * omega[2]) +
             upsilon[2] * (c52 + c93);
result[36] = -c34 + c36;
result[37] = c80 + c81;
result[38] = c31 * c94 + 1;
result[39] = upsilon[0] * (c43 + c89) + upsilon[1] * (c62 + c84 - c85 + c86) +
             upsilon[2] * (c40 * c95 - c60 * c94 + c82);
result[40] = upsilon[0] * (-c56 + c57 + c59 + c75) + upsilon[1] * (c48 + c91) +
             upsilon[2] * (c53 + c55 * c95 - c92 * c94);
result[41] = upsilon[0] * (c67 + c77) + upsilon[1] * (c87 + c93) +
             upsilon[2] * (c70 * c95 - c90 * c94);
