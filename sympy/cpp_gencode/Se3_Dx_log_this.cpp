...
Scalar const c65 =
    -c0 * c62 + c18 * c64 + c19 * c63 - c27 * c45 - c3 * c62 + 4 * c47 + c61;
Scalar const c66 = 0.25 * pow(c39, 2) / pow(c38, 2);
Scalar const c67 = c40 / c36;
Scalar const c68 = -c0 * c56 + c18 * c59 + c18 * c60 - c3 * c56 + c43 * c55 -
                   c45 * c55 + c46 * c57 + c65 * c66 - c65 * c67;
...
Scalar const c116 = -c101 * c27 + c103 * c63 - c108 * c27 + 4 * c110 -
                    c27 * c79 + c63 * c86 + c72;
Scalar const c117 = -c101 * c55 + c106 * c55 - c108 * c55 + c109 * c57 +
                    c115 * c85 + c116 * c66 - c116 * c67 - c55 * c79 +
                    c60 * c85;
...
Scalar const c147 = -c135 * c27 - c141 * c27 + c142 * c63 - c27 * c95 +
                    c63 * c98 + c64 * c97 + c90;
Scalar const c148 = c115 * c97 - c135 * c55 + c139 * c55 - c141 * c55 +
                    c142 * c57 + c147 * c66 - c147 * c67 - c55 * c95 +
                    c59 * c97;
...
Scalar const c164 =
    -c0 * c160 - c160 * c2 - c160 * c3 + c163 * c66 - c163 * c67;
...
result[0] = t[0] * (c26 * c42 + c49 * c54 + c68 * c69) + t[1] * (c77 + c88) +
            t[2] * (c100 + c93);
result[1] = t[0] * (c114 * c54 + c117 * c69 + c42 * (c105 + c111)) +
            t[1] * (c133 + c134) + t[2] * (-c119 + c125 + c128 + c59);
result[2] = t[0] * (c146 * c54 + c148 * c69 + c42 * (c138 + c143)) +
            t[1] * (c150 + c151 + c154 - c60) + t[2] * (c155 + c156);
result[3] = t[0] * (c164 * c69 + c170 * c42 + c171 * c54) +
            t[1] * (-c159 + c174) + t[2] * (c175 + c176);
result[4] = c42 * c52 + 1;
result[5] = c177 + c178;
result[6] = -c179 + c180;
result[7] = t[0] * (c191 + c88) +
            t[1] * (c183 * c49 + c184 * c68 + c42 * (c21 + c48)) +
            t[2] * (-c115 + c151 + c186 + c190);
result[8] = t[0] * (c134 + c155) +
            t[1] * (c113 * c42 + c114 * c183 + c117 * c184) +
            t[2] * (c192 + c193);
result[9] = t[0] * (c125 - c150 + c154 + c60) +
            t[1] * (c146 * c183 + c148 * c184 + c42 * (c143 + c144)) +
            t[2] * (c194 + c77);
result[10] = t[0] * (c159 + c174) +
             t[1] * (c164 * c184 + c171 * c183 + c42 * (c167 + c169)) +
             t[2] * (-c195 + c196);
result[11] = -c177 + c178;
result[12] = c182 * c42 + 1;
result[13] = c197 + c198;
result[14] = t[0] * (c100 + c192) + t[1] * (c115 + c125 - c186 + c190) +
             t[2] * (c200 * c49 + c201 * c68 + c42 * (c25 + c48));
result[15] = t[0] * (c119 + c128 + c151 - c59) + t[1] * (c193 + c93) +
             t[2] * (c114 * c200 + c117 * c201 + c42 * (c111 + c112));
result[16] = t[0] * (c133 + c156) + t[1] * (c191 + c194) +
             t[2] * (c145 * c42 + c146 * c200 + c148 * c201);
result[17] = t[0] * (-c175 + c176) + t[1] * (c195 + c196) +
             t[2] * (c164 * c201 + c171 * c200 + c42 * (c167 + c168));
result[18] = c179 + c180;
result[19] = -c197 + c198;
