...
bool testSpline() {
  ...
  SE3d T = spline.parent_T_spline(1, 1.0);
  SE3d T2 = spline.parent_T_spline(2, 0.0);
  ...
  Eigen::Matrix4d Dt_parent_T_spline = spline.Dt_parent_T_spline(1, 0.5);
  ...
  Eigen::Matrix4d Dt2_parent_T_spline = spline.Dt2_parent_T_spline(1, 0.5);
